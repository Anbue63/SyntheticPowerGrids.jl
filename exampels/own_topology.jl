...
x = PGGeneration1(num_nodes = num_nodes, nodal_parameters = nodal_parameters, nodal_shares = nodal_shares, P_vec = P_vec, embedded_graph = own_graph, coupling = :predefined, edge_parameters = edge_parameters, lines = :StaticLine)
