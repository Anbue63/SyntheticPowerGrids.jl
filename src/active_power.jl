...
function get_power_distribution(pg_struct)
    if pg_struct.power_distribution == :Bimodal # Bimodal Distribution for the active power
        P_vec = get_bimodal_distribution(pg_struct.num_nodes, pg_struct.P0)
    elseif pg_struct.power_distribution ==  :Plus_Minus_1
        P_vec = get_plus_minus_1_distribution(pg_struct.num_nodes)
    else 
...
"""
function get_bimodal_distribution(num_nodes::Int64, P0::Float64)
...
"""
function get_plus_minus_1_distribution(num_nodes::Int64)
